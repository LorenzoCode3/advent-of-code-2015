...
for line in lines.splitlines():
    ...
    raindeers.setdefault(name, dict({'speed': speed, 'fly_time': fly_time, 'rest_time': rest_time, 
                                'is_resting': False, 'endurance': fly_time, 'distance_traveled': 0, 'resting_time': 0}))
...
winner_distance = 0
for raindeer in raindeers.values():
    if raindeer['distance_traveled'] > winner_distance:
        winner_distance = raindeer['distance_traveled']
